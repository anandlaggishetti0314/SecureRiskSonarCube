...
public class ClaimsServiceImpl implements ClaimDetailsService {
	...
	public ClaimsServiceImpl(ClaimsDetailsRepository claimsRepo) {
	...
	public String createClaimDetails(ClaimDetailsDto claimDetailsDto) {
		...
		if (claimDetailsDto != null) {
			...
			try {
				...
				claimsDetails.setCreateDate(new SimpleDateFormat(pattern)
						.parse(new SimpleDateFormat(pattern).format(new Date())));
	...
	public ClaimsDetails updateClaimDetails(ClaimDetailsDto claimDetailsDto, String id) {
		...
		try {
			claimsDetails.setUpdateDate(
					new SimpleDateFormat(pattern).parse(new SimpleDateFormat(pattern).format(new Date())));
		} catch (ParseException e) {
			e.printStackTrace();
		}
