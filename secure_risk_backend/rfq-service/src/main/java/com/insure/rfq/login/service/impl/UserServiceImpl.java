...
public class UserServiceImpl implements UserService {
	...
	public UserServiceImpl(UserRepositiry userRepositiry, LocationRepository locationRepository, DepartmentRepository departmentRepository, DesignationRepository designationRepository, PasswordEncoder bCryptPasswordEncoder, ModelMapper modelMapper, PasswordEncoder encoder, EmailSender emailSernder, PasswordGenerator passwordGenerator) {
		...
		this.emailSernder = emailSernder;
