...
public class AgeBindingReportPdfGenerator {
    ...
    String count5 = "Count";
    String s = " :: 1+3";
    String s2 = "Sum Insured :";

    public AgeBindingReportPdfGenerator(EmpDependentRepository dependentRepository, AgeBindingData ageBindingData, EmployeeRepository employeeRepository,  @Value("classpath:configfile/logo.png")Resource resource) {
        this.dependentRepository = dependentRepository;
        this.ageBindingData = ageBindingData;
        ...
        if (coverageDetails.isFamilyDefication13()) {
            ...
            for (Map.Entry<Double, List<EmployeeDepedentDetailsEntity>> entry : groupedBySumInsured.entrySet()) {
                ...
                if (isOnePlusThree(sumInsuredGroup, id, golbalEmployeeDetailsBasedOnRfqId)) {
                    ...
                    table1.addCell(createCenteredCell(count5));
                    document.add(table1);
                    log.info("No of Tables Generated for 1+3 = {}", pageCount);
                    pageCount++;


                    Paragraph mainHeading1 = new Paragraph(" " + s2 + " " + sumInsuredValue + s,
                            boldBlueFonts);
                    ...
                    table2.addCell(createCenteredCell(total1));
                    ...
                    table6.addCell(createCenteredCell(total1));
        ...
        if (coverageDetails.isFamilyDefication15()) {
            ...
            for (Map.Entry<Double, List<EmployeeDepedentDetailsEntity>> entry : groupedBySumInsured.entrySet()) {
                ...
                if (isOnePlusFive(sumInsuredGroup, id, golbalEmployeeDetailsBasedOnRfqId)) {
                    ...
                    table122.addCell(createCenteredCell(count5));
                    document.add(table122);
                    log.info("No of Tables Generated for 1+5 = {}", pageCount);
                    pageCount++;
//

                    Paragraph mainHeading1 = new Paragraph(s2 + " " + sumInsuredValue + s1,
                            boldBlueFonts);
                    mainHeading1.setAlignment(alignCenter);
                    ...
                    table21.addCell(createCenteredCell(total1));
                    ...
                    table7.addCell(createCenteredCell(total1));
...
//				| coverageDetails.isFamilyDeficationParents()
    ...
    private PdfPCell createCellWithFont(String text, Font font) throws IOException {
    ...
    public Set<String> getAllSetOfRelationOfOnePlusThree(String rfqId) {
        ...
        Set<String> collect = employeeRepository.findByRfqId(rfqId).stream().map(EmployeeDepedentDetailsEntity::getEmployeeId).collect(Collectors.toSet());
