...
public class ClientListContactDetailsServiceImpl implements ClientListContactDetailsService {
	...
	public ClientListContactDetailsServiceImpl(ClientListContactDetailsRepository clientListContactDetailsRepository, ProductRepository productRepository, ClientListRepository clientListRepository, DesignationRepository designationRepository, ClientListRoleInfoRepository clientListRoleInfoRepository) {
		this.clientListContactDetailsRepository = clientListContactDetailsRepository;
		this.productRepository = productRepository;
		this.clientListRepository = clientListRepository;
		this.designationRepository = designationRepository;
		this.clientListRoleInfoRepository = clientListRoleInfoRepository;
	}
