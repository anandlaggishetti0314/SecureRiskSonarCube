...
public class UserJwtAuthenticationServiceImp implements UserJwtAuthenticationService {
	...
	public UserJwtAuthenticationServiceImp(RefreshTokenRepository refreshTokenRepository, JwtService jwtService, OperationRepository operationRepository, UserRepositiry newRepositiry, DepartmentRepository departmentRepository, DesignationOperationRepository designationOperationRepository, ModelMapper mapper, AuthenticationManager authenticationManager, LocationRepository locationRepository, DesignationRepository designationRepository, UserRepositiry userRepositiry, LoginUserDetailsService loginUserDetailsService) {
		this.refreshTokenRepository = refreshTokenRepository;
		this.jwtService = jwtService;
		this.operationRepository = operationRepository;
		this.newRepositiry = newRepositiry;
		this.departmentRepository = departmentRepository;
		this.designationOperationRepository = designationOperationRepository;
		this.mapper = mapper;
