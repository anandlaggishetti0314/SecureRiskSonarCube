...
public class CoverageDetailsServiceImpl
    ...
    public CoverageDetailsServiceImpl(PolicyTermsRepository policyTermsRepository, CoverageDetailsRepository cdEBRepo, CorporateDetailsRepository corporateDetailsRepo, ExpiryPolicyDetailsRepository expiryPolicyDetailsRepository, CoverageDetailsPdfGenerator coverageDetailsPdfGenerator, EmpDependentRepository empDepRepo, CoverageValidateFilenamesRepository filesRepo, IrdaPdfGenerator generator, EmployeeRepository employeeRepository, CoverageFileUploadRepository fileUploadRepo, EmpDependentHeaderRepository empDepHeaderRepo, ExcelReportHeadersRepository reportHeaderRepo, ClaimsMisRepository claimsMisRepo, TpaRepository tpaRepo, Map<String, Integer> columnMapping, AgeBindingReportPdfGenerator ageBindingReportPdfGenerator, ModelMapper modelMapper, ExcelUtils excelUtils, ClaimsDetailsRepository claimsDetailsRepository, EmailAlongAttachement emailAlongAttachement) {
        this.policyTermsRepository = policyTermsRepository;
        this.cdEBRepo = cdEBRepo;
        this.corporateDetailsRepo = corporateDetailsRepo;
        this.expiryPolicyDetailsRepository = expiryPolicyDetailsRepository;
        this.coverageDetailsPdfGenerator = coverageDetailsPdfGenerator;
        this.empDepRepo = empDepRepo;
        this.filesRepo = filesRepo;
        this.generator = generator;
        this.employeeRepository = employeeRepository;
        this.fileUploadRepo = fileUploadRepo;
        this.empDepHeaderRepo = empDepHeaderRepo;
        this.reportHeaderRepo = reportHeaderRepo;
        this.claimsMisRepo = claimsMisRepo;
        this.tpaRepo = tpaRepo;
        this.columnMapping = columnMapping;
        this.ageBindingReportPdfGenerator = ageBindingReportPdfGenerator;
        this.modelMapper = modelMapper;
        this.excelUtils = excelUtils;
        this.claimsDetailsRepository = claimsDetailsRepository;
        this.emailAlongAttachement = emailAlongAttachement;
    }
    ...
    public void validateBasedOnColumnIndex(String employeeId, String TempEmpID, String sumInsured,
        ...
        if (colIndex == genderColumnIndex) {
            if (dataRow.getCell(genderColumnIndex) != null) {
                ...
                Cell genderCell = dataRow.getCell(genderColumnIndex);
                if (genderCell.getCellType() == CellType.STRING) {
                    gender = dataRow.getCell(genderColumnIndex).getStringCellValue().replace(" ", "");
...
//
                        ...
                        String sumInsuredStr = sumInsuredCell.getStringCellValue().replace(",", "");
                        try {
...
//
            ...
            if (dataRow.getCell(claimedAmountColumnIndex) != null) {
                ...
                if (claimedAmountCell.getCellType() == CellType.NUMERIC) {
                    ...
                    String sumInsuredStr = claimedAmountCell.getStringCellValue().replace(",", "");
                    try {
            ...
            if (dataRow.getCell(paidAmountColumnIndex) != null) {
                ...
                if (paidAmountCell.getCellType() == CellType.NUMERIC) {
                    ...
                    String sumInsuredStr = paidAmountCell.getStringCellValue().replace(",", "");
                    try {
                        double claimedAmountDouble = Double.parseDouble(sumInsuredStr);
                        DecimalFormat df = new DecimalFormat("#");
                        String stringValue = df.format(claimedAmountDouble).trim();
            ...
            if (dataRow.getCell(outstandingAmountColumnIndex) != null) {
                ...
                if (outstandingAmountCell.getCellType() == CellType.NUMERIC) {
                    ...
                    switch (outstandingAmountCell.getCellType()) {
                        ...
                        case STRING: {
                            String sumInsuredStr = outstandingAmountCell.getStringCellValue().replace(",", "");
                            try {
                                double sumInsuredDouble = Double.parseDouble(sumInsuredStr);
                                DecimalFormat df = new DecimalFormat("#");
                                String stringValue = df.format(sumInsuredDouble).trim();
