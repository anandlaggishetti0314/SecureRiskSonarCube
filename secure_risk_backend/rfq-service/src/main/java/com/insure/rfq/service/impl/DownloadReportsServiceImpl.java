...
public class DownloadReportsServiceImpl implements DownloadReportsService {
	...
	public DownloadReportsServiceImpl(IrdaPdfGenerator irdaPdfGenerator, ExpiryPolicyDetailsRepository expiryPolicyDetailsRepository, EmployeeRepository employeeRepository, CoverageDetailsRepository cdEBRepo, CorporateDetailsRepository corporateDetailsRepo, CoverageDetailsPdfGenerator coverageDetailsPdfGenerator, ModelMapper modelMapper, CoverageDetailsRepository coverageDetailsRepository, AgeBindingReportPdfGenerator ageBindingReportPdfGenerator, CoverageDetailsServiceImpl coverageDetailsServiceImpl, CorporateDetailsService corporateDetailsService, ClaimAnalysisReport claimAnalysisReport, EmpDependentRepository dependentRepository, PolicyTermsRepository policyTermsRepository, ClaimsMisRepository claimsMisRepository, ClaimsDetailsRepository claimsDetailsRepository) {
		this.irdaPdfGenerator = irdaPdfGenerator;
		...
		this.coverageDetailsServiceImpl = coverageDetailsServiceImpl;
		...
		this.claimsMisRepository = claimsMisRepository;
