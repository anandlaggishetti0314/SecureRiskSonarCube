...
public class InsurerBankDetailsServiceImpl implements InsurerBankDetailsService {
    ...
    public InsurerBankDetailsServiceImpl(InsurerBankDetailsRepository insurerBankDetailsRepository, ProductRepository productRepository, ClientListRepository clientListRepository) {
        this.insurerBankDetailsRepository = insurerBankDetailsRepository;
