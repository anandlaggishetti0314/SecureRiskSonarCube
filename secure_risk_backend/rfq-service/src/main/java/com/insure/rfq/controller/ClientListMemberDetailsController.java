...
public class ClientListMemberDetailsController {
	...
	public ClientListMemberDetailsController(ClientListMemberDetailsService clientListMemberDetailsService, ClientListEnrollementUploadService clientListEnrollementUploadService) {
		this.clientListMemberDetailsService = clientListMemberDetailsService;
		this.clientListEnrollementUploadService = clientListEnrollementUploadService;
	}
