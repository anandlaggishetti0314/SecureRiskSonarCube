...
public class RFQReportPDfGenerator {
	...
	public RFQReportPDfGenerator(@Value("classpath:configfile/logo.png")Resource resource, @Value("${file.path.coverageMain}")String mainpath, CorporateDetailsRepository repo) {
