...
class ApiPayload {
  final String rfqId;
  final double claimPaidReimbursement;
  final double claimPaidCashless;
  final double claimOutstandingReimbursement;
  final double claimOutstandingCashless;
  final double opdClaimPaidReimbursement;
  final double opdClaimPaidCashless;
  final double opdClaimOutstandingReimbursement;
  final double opdClaimOutstandingCashless;
  final double corporateBufferClaimPaidReimbursement;
  final double corporateBufferClaimPaidCashless;
  final double corporateBufferClaimOutstandingReimbursement;
  final double corporateBufferClaimOutstandingCashless;
  final double corporateBufferAmount;
  final double perFamilyLimit;
  final double maxCasesNo;
  final double maxSumInsured;
  final String policyPeriod;
  final double premiumperiod;
  final double totalSumInsured;
  final double numberOfClaims;
  final double claimedAmont;
  final double settledAmont;
  final double pendingAmont;
...
class RenewalEditClaimsDetails extends StatefulWidget {
  ...
  Future<void> updateRenewalClaimsDetails(BuildContext context) async {
    var body = {
      "claimPaidReimbursement": claimPaidReimbursement.text,
      "claimPaidCashless": claimPaidCashless.text,
      "claimOutstandingReimbursement": claimOutstandingReimbursement.text,
      "claimOutstandingCashless": claimOutstandingCashless.text,
      "opdClaimPaidReimbursement": opdClaimPaidReimbursement.text,
      "opdClaimPaidCashless": opdClaimPaidCashless.text,
      "opdClaimOutstandingReimbursement": opdClaimOutstandingReimbursement.text,
      "opdClaimOutstandingCashless": opdClaimOutstandingCashless.text,
      "corporateBufferClaimPaidReimbursement":
          corporateBufferClaimPaidReimbursement.text,
      "corporateBufferClaimPaidCashless": corporateBufferClaimPaidCashless.text,
      ...
      "corporateBufferAmount": CorporateBufferAmount.text,
      "perFamilyLimit": perfamilylimit.text,
      "maxCasesNo": maxNoOfCases.text,
      "maxSumInsured": perFamilyMaximumSI.text,
      "policyperiod": PolicyPeriod.text,
      "premiumPaid": Premiumperiod.text,
      "claimsNo": NumberOfClaims.text,
      "claimedAmount": ClaimedAmont.text,
      "totalSumInsured": TotalSumInsured.text,
      "settledAmount": SettledAmont.text,
      "pendingAmount": PendingAmont.text
    };
...
class EditClaimsDetailsState extends State<RenewalEditClaimsDetails> {
  ...
  Future<void> fetchApiData() async {
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      ('object:$jsonData');
      setState(() {
        double claimPaidReimbursementValue = jsonData['claimPaidReimbursement'];
        claimPaidReimbursement.text = claimPaidReimbursementValue.toString();

        double claimPaidCashlessValue = jsonData['claimPaidCashless'];
        claimPaidCashless.text = claimPaidCashlessValue.toString();

        double claimOutstandingReimbursementValue =
            jsonData['claimOutstandingReimbursement'];
        claimOutstandingReimbursement.text =
            claimOutstandingReimbursementValue.toString();

        double claimOutstandingCashlessValue =
            jsonData['claimOutstandingCashless'];
        claimOutstandingCashless.text =
            claimOutstandingCashlessValue.toString();

        double opdClaimPaidReimbursementValue =
            jsonData['opdClaimPaidReimbursement'];
        opdClaimPaidReimbursement.text =
            opdClaimPaidReimbursementValue.toString();

        double opdClaimPaidCashlessValue =
            jsonData['opdClaimOutstandingCashless'];
        opdClaimPaidCashless.text = opdClaimPaidCashlessValue.toString();

        double opdClaimOutstandingReimbursementValue =
            jsonData['opdClaimOutstandingReimbursement'];
        opdClaimOutstandingReimbursement.text =
            opdClaimOutstandingReimbursementValue.toString();

        // opdClaimOutstandingCashless.text = jsonData["opdClaimPaidCashless"];
        double opdClaimOutstandingCashlessValue =
            jsonData['claimOutstandingCashless'];
        opdClaimOutstandingCashless.text =
            opdClaimOutstandingCashlessValue.toString();

        double corporateBufferClaimPaidReimbursementValue =
            jsonData['corporateBufferClaimOutstandingReimbursement'];
        corporateBufferClaimPaidReimbursement.text =
            corporateBufferClaimPaidReimbursementValue.toString();

        double corporateBufferClaimPaidCashlessValue =
            jsonData['corporateBufferClaimPaidCashless'];
        corporateBufferClaimPaidCashless.text =
            corporateBufferClaimPaidCashlessValue.toString();

        double corporateBufferClaimOutstandingReimbursementValue =
            jsonData['corporateBufferClaimPaidReimbursement'];
        corporateBufferClaimOutstandingReimbursement.text =
            corporateBufferClaimOutstandingReimbursementValue.toString();

        double corporateBufferClaimOutstandingCashlessValue =
            jsonData['corporateBufferClaimOutstandingCashless'];
        corporateBufferClaimOutstandingCashless.text =
            corporateBufferClaimOutstandingCashlessValue.toString();

        CorporateBufferAmount.text =
            jsonData["corporateBufferAmount"].toString();

        perfamilylimit.text = jsonData["perFamilyLimit"].toString();

        maxNoOfCases.text = jsonData["maxCasesNo"].toString();

        perFamilyMaximumSI.text = jsonData["perFamilyLimit"].toString();
        ('family:$jsonData["perFamilyLimit"]');
        PolicyPeriod.text = jsonData["policyperiod"];
        Premiumperiod.text = jsonData["premiumPaid"].toString();
        TotalSumInsured.text = jsonData["totalSumInsured"].toString();
        NumberOfClaims.text = jsonData["claimsNo"].toString();
        ClaimedAmont.text = jsonData["claimedAmount"].toString();
        SettledAmont.text = jsonData["settledAmount"].toString();
        PendingAmont.text = jsonData["pendingAmount"].toString();
