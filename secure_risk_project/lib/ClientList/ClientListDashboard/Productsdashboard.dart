      ...
      child: Container(
        ...
        child: ListView(
            children: _buildListTiles(fieldTextColor, productIdvar, clientId,
                productNameVar, context)),
      ),
    );
  }

  List<Widget> _buildListTiles(Color fieldTextColor, String productId,
      int clientId, String productNameVar, BuildContext context) {
    ...
    //  {"icon": Icons.person, "title": "App Access", "onTap": () {}},
      ...
      {"icon": Icons.person, "title": "Claims MIS", "onTap": () {      
      ...
      if (productId == "1001")
        {
          ...
          "onTap": () {
            onSelectDashboard(NetworkHospitalForm(
                clientId: clientId, productIdvar: productIdvar));
          },
        },
      {
        "icon": Icons.person,
                ...
                if (dropdownItem == "Master List") {
                  ...
                  onSelectDashboard(
                     // ActiveList(clientId: clientId, productId: productId));
                      AdditionList(clientId: clientId, productId: productId));
            ...
            return ListTile(
              ...
              onTap: () {
                ...
                if (dropdownItems == "Master List") {
                  onSelectDashboard(
                      Claims_MasterList(clientId: clientId, productId: productId));
                } else if (dropdownItems == "Approved") {
                  onSelectDashboard(
                      Claims_ApprovedList(clientId: clientId, productId: productId));
                }else if (dropdownItems == "Rejected") {
                  onSelectDashboard(
                      Claims_RejectedList(clientId: clientId, productId: productId));
              }else if (dropdownItems == "Pending") {
                  onSelectDashboard(
                    Claims_PendingList(clientId: clientId, productId: productId));
              }
              },
            );
          }).toList(),
