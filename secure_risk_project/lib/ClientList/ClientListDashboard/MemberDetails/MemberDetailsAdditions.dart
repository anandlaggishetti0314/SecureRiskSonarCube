...
class AdditionList extends StatefulWidget {
  int clientId;
  String productId;
  AdditionList({Key? key, required this.clientId, required this.productId})
      : super(key: key);
  @override
  State<AdditionList> createState() => _PendingListState();
}

class _PendingListState extends State<AdditionList> {
  ...
  //new
  exportAdditionsMemberDetails(String fileName) async {
    int clientListId = widget.clientId;
    int? productId = int.tryParse(widget.productId);

    String urlString =
        "${ApiServices.baseUrl}${ApiServices.exportMemberDetailsAdditionsApi}clientListId=$clientListId&productId=$productId";
  ...
  additionsMemberDetailsDownloadTemplate(String fileName) async {
    String urlString =
                    ...
                    Align(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            exportAdditionsMemberDetails(
                                "member_details_additions");
                          },
                          child: Container(
                            child: Row(
                    ...
                    Align(
                      child: Container(
                        ...
                        child: ElevatedButton(
                          style: SecureRiskColours.customButtonStyle(),
                          onPressed: () {
                            additionsMemberDetailsDownloadTemplate(
                                "additionList");
                          },
                          child: Container(
                            child: Row(
