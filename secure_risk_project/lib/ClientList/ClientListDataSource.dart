                                    ...
                                    ListTile(
                                      ...
                                      onTap: () {                                       
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                              Dashboard(productNameVar:item.productName,productIdvar:item.productId,clientId:clientId,clientNameVar:clientNameVar)),                                                
                                        );
                                      },
                                    ),
                                    Divider(
          ...
          return GestureDetector(
            onTap: () {
              openProductsDialog(context, insurer.clientId, _fetchData,
                  onDesignationChanged, insurer.designation, insurer.clientName);
            },
            child: Container(
              padding: EdgeInsets.all(5),
              alignment: Alignment.center,
              child: Text(
                dataCell.value.toString(),
                overflow: TextOverflow.ellipsis,
                style: GoogleFonts.poppins(color: Color.fromARGB(255, 7, 79, 138),decoration: TextDecoration.underline),
