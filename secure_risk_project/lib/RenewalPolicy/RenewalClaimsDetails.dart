...
class RenewalClaimsDetails extends StatefulWidget {
  ...
  Future<void> fetchApiData(BuildContext context) async {
    ...
    var body = {
      "rfqId": rfqId,
      "claimPaidReimbursement": Reimbursment1.text.isNotEmpty
          ? double.tryParse(Reimbursment1.text)
          : null,
      "claimPaidCashless":
          Cashless1.text.isNotEmpty ? double.tryParse(Cashless1.text) : null,
      "claimOutstandingReimbursement": Reimbursment2.text.isNotEmpty
          ? double.tryParse(Reimbursment2.text)
          : null,
      "claimOutstandingCashless":
          Cashless2.text.isNotEmpty ? double.tryParse(Cashless2.text) : null,
      "opdClaimPaidReimbursement": Reimbursment3.text.isNotEmpty
          ? double.tryParse(Reimbursment3.text)
          : null,
      "opdClaimPaidCashless":
          Cashless3.text.isNotEmpty ? double.tryParse(Cashless3.text) : null,
      "opdClaimOutstandingReimbursement": Reimbursment4.text.isNotEmpty
          ? double.tryParse(Reimbursment4.text)
          : null,
      "opdClaimOutstandingCashless":
          Cashless4.text.isNotEmpty ? double.tryParse(Cashless4.text) : null,
      "corporateBufferClaimPaidReimbursement": Reimbursment5.text.isNotEmpty
          ? double.tryParse(Reimbursment5.text)
          : null,
      "corporateBufferClaimPaidCashless":
          Cashless5.text.isNotEmpty ? double.tryParse(Cashless5.text) : null,
      "corporateBufferClaimOutstandingReimbursement":
          Reimbursment6.text.isNotEmpty
              ? double.tryParse(Reimbursment6.text)
              : null,
      "corporateBufferClaimOutstandingCashless":
          Cashless6.text.isNotEmpty ? double.tryParse(Cashless6.text) : null,
      "corporateBufferAmount": CorporateBufferAmount.text.isNotEmpty
          ? double.tryParse(CorporateBufferAmount.text)
          : null,
      "perFamilyLimit": perfamilylimit.text.isNotEmpty
          ? double.tryParse(perfamilylimit.text)
          : null,
      "maxCasesNo": maxNoOfCases.text.isNotEmpty
          ? double.tryParse(maxNoOfCases.text)
          : null,
      "maxSumInsured": perFamilyMaximumSI.text.isNotEmpty
          ? double.tryParse(perFamilyMaximumSI.text)
          : null,
      "policyPeriod": PolicyPeriod.text,
      "premiumPaid": Premiumperiod.text,
      "totalSumInsured": TotalSumInsured.text.isNotEmpty
          ? double.tryParse(TotalSumInsured.text)
          : null,
      "claimsNo": NumberOfClaims.text.isNotEmpty
          ? int.parse(NumberOfClaims.text)
          : null,
      "claimedAmount": ClaimedAmont.text.isNotEmpty
          ? double.tryParse(ClaimedAmont.text)
          : null,
      "settledAmount": SettledAmont.text.isNotEmpty
          ? double.tryParse(SettledAmont.text)
          : null,
      "pendingAmount": PendingAmont.text.isNotEmpty
          ? double.tryParse(PendingAmont.text)
          : null,
    };
                        ...
                        child: Padding(
                          ...
                          child: Material(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Policy Period in year ',
